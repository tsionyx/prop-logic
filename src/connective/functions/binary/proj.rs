...
impl<const I: usize, E, UnaryOp, T> Reducible<2, E, T> for ProjectAndUnary<I, UnaryOp>
where
    E: Evaluable<T> + Clone, // TODO: try to get rid of this `Clone` requirement
    UnaryOp: TruthFn<1> + Reducible<1, E, T>,
    Projection<I>: TruthFn<2> + Reducible<2, E, T>,
{
...
impl<E: Evaluable<T>, T> Reducible<2, E, T> for Projection<0> {
...
impl<E: Evaluable<T>, T> Reducible<2, E, T> for Projection<1> {
